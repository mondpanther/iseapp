...
# About 
The Innovation Strategy Explorer is an interactive tool to tailor and visualise indicators of innovation capabilites at the technology type, country and (so far only for the UK) regional level. This includes

- Revealed Technological Advantage (RTA, made symmetric so that between 0 and 2 with values larger 1 indicating comparative advantage in a technology area)
- An estimate of the average value of indirect and indirect knowledge spillovers (Average Spillovers, in $ Million)
