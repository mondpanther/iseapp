...
ui <- function(req) {
  bslib::page_navbar(
    ...
    header = list(
      ...
      #     console.log('restoreFromUrl called');
      ...
      #     console.log('Parsed params:', paramsObj);
      #     console.log('Param count:', Object.keys(paramsObj).length);
